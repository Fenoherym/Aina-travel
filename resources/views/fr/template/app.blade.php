...
<head>
    ...
    <title>Guide touristique à Madagascar</title>
...
<body>
    ...
    <header x-data="{
        ...
        isSticky: false
    }" class="@if (Route::currentRouteName() !== 'fr.home') not-home @endif">
        @if (Route::currentRouteName() === 'fr.home')
            {{-- Nabar --}}
                ...
                <ul class="menu" :class="active ? 'active' : ''">
                    ...
                    <li class="dropdown-list">
                        ...
                        <ul class="dropdown-list-item">
                            <li><a href="{{ route('fr.circuit.lemur') }}">Special visite grand lemur de Madagascar</a>
                            </li>
                            <hr>
                            <li><a href="{{ route('fr.circuit.bemaraha') }}">TSINGY DE BEMARAHA- TSIRIBIHINA</a></li>
                        </ul>
                    </li>
                    <li><a href="{{ route('fr.home') }}#about">A-propos</a></li>
                    <li><a href="{{ route('fr.contact') }}">Contact</a></li>
                    <li><a href="{{ route('home') }}#">En <i class="fa-solid fa-language"></i></a></li>
                </ul>
            ...
            <div class="header-body">
                <div class="content">
                    ...
                    <h1>Départ vers des terres inconnues</h1>
        ...
        @else
            <div class="topbar">
                <h3 class="logo">{!! $logo->content !!}</h3>
                <ul class="menu" :class="active ? 'active' : ''">
                    <li class="active"><a href="{{ route('fr.home') }}">Accueil</a></li>
                    <li class="dropdown-list">
                        <a href="#">Circuit</a>
                        <ul class="dropdown-list-item">
                            <li><a href="{{ route('fr.circuit.lemur') }}">Special visite grand lemur de Madagascar</a>
